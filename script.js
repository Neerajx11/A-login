...
$(".foot-var").on("click", function () {
  if (this.textContent == "student's") {
    ...
    $(".hero")
      .delay(200)
      .css({ "background-image": "url(img/student-bg.jpg)" });
...
$(".shift-student").on("click", function () {
  ...
  studentpass.type == "password"
    ? studentpass.setAttribute("type", "text")
    : studentpass.setAttribute("type", "password");
});
...
$(".shift-teacher").on("click", function () {
  ...
  teacherpass.type == "password"
    ? teacherpass.setAttribute("type", "text")
    : teacherpass.setAttribute("type", "password");
});
